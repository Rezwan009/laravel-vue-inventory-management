                ...
                <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <h6 class="collapse-header">Porducts</h6>
                                <router-link :to="{name:'product-create'}" class="collapse-item">
                                    Add Product
                                </router-link>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap7" class="collapse" aria-labelledby="headingBootstrap"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <router-link :to="{name:'today-order'}" class="collapse-item">
                                    Today's Order
                                </router-link>
                                <router-link :to="{name:'search-order'}" class=" collapse-item">
                                    Search Order
                                </router-link>
                            </div>
                        </div>
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle"
                                                src="{{ asset('backend/assets/img/man.png') }}"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle"
                                                src="{{ asset('backend/assets/img/girl.png') }}"
                                                style="max-width: 60px" alt="">
